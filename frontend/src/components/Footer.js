        ...
        <div className="grid md:grid-cols-12 gap-8 mb-8">
          ...
          <div className="md:col-span-2">
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">CT Scan Interpretation</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">ECG Analysis</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">For Hospitals</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">For Clinics</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 pt-8 pb-12">
          <div className="flex flex-col md:flex-row md:items-center justify-between">
            ...
            <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-3 w-full md:w-auto">
              ...
              />
              <button className="px-6 py-3 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors uppercase tracking-wide text-sm">
                Subscribe
              </button>
            </div>
          </div>
