          ...
          {deploymentOptions.map((option, index) => (
            ...
            >
              ...
              <div className="p-8 flex-grow flex flex-col">
                ...
                <a href="#" className="mt-8 text-purple-600 inline-flex items-center font-medium hover:text-purple-800">
        ...
        <div className="mt-20 bg-white rounded-3xl shadow-lg overflow-hidden">
          <div className="grid md:grid-cols-2 items-stretch">
            <div className="relative bg-gradient-primary overflow-hidden">
              ...
              <div className="relative p-12 md:p-16 flex flex-col h-full justify-center">
                ...
                <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 mt-auto">
                  ...
                  <a href="#" className="btn btn-outline border-white text-white hover:bg-white/10">
                    Contact Us
                  </a>
                </div>
              </div>
            ...
            <div className="p-12 md:p-16 flex flex-col justify-center">
              <h3 className="text-2xl font-bold text-gray-900 mb-6">How we support your deployment</h3>
