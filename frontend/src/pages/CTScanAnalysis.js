    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">
          Upload CT scan images for AI-powered analysis
        </p>
      </div>
      ...
      <div className="bg-white shadow-md rounded-lg p-6 mb-6">
        <h2 className="text-xl font-semibold mb-4">Upload CT Scan Image</h2>
        <ImageUploader
      ...
      <div className="mt-8 bg-blue-50 rounded-lg p-6">
        <h3 className="text-lg font-semibold mb-2 text-blue-800">About CT Scan Analysis</h3>
        <p className="text-blue-700 mb-4">
          Our AI model can detect various brain conditions including:
        </p>
        ...
        <p className="text-blue-700 text-sm">
          ...
          Always consult with a qualified neurologist for proper interpretation of results.
        </p>
      </div>
    </div>
  );
