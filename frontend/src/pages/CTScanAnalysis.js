...
const CTScanAnalysis = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      ...
      setResult({
        success: true,
        findings: 'No evidence of acute intracranial hemorrhage, mass effect, or midline shift. Ventricles, cisterns, and sulci are normal in size and configuration. Gray-white matter differentiation is preserved.',
        confidence: 94,
        conditions: [
          { name: 'Hemorrhage', probability: 2, severity: 'None' },
          { name: 'Mass Effect', probability: 1, severity: 'None' },
          { name: 'Infarction', probability: 3, severity: 'None' },
          { name: 'Hydrocephalus', probability: 1, severity: 'None' }
        ],
        recommendation: 'No urgent follow-up needed based on this scan. Consider clinical correlation.'
      });
    }, 3000);
  };
      ...
      <main className="flex-grow bg-gray-50 py-10">
        <div className="container-custom">
          <div className="flex items-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900">CT Scan Analysis</h1>
          </div>
          
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white rounded-xl shadow-md overflow-hidden p-6">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">Upload CT Scan Image</h2>
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
                  {preview ? (
                    ...
                    <div className="mb-4">
                      ...
                      <p className="text-gray-600 mt-2">Drag and drop a CT scan image, or click to select</p>
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden p-6">
              ...
              {isAnalyzing ? (
                <div className="flex flex-col items-center justify-center h-64">
                  ...
                  <p className="mt-4 text-gray-600">Analyzing CT scan image...</p>
                ...
                <div className="flex flex-col items-center justify-center h-64 text-gray-500">
                  ...
                  <p className="mt-4">Upload a CT scan image to view analysis results</p>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="mt-8 bg-white rounded-xl shadow-md overflow-hidden p-6">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">About CT Scan Analysis</h2>
