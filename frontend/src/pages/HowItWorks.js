    ...
    <div className="min-h-screen flex flex-col bg-black text-white">
      ...
      <main className="flex-grow py-10 page-transition">
        <div className="container-custom">
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex">
                  ...
                  <div>
                    <h3 className="heading-card mb-2">Image Acquisition</h3>
                ...
                <div className="flex">
                  ...
                  <div>
                    <h3 className="heading-card mb-2">Results Generation</h3>
                    <p className="text-gray-300">
                ...
                <div className="flex">
                  ...
                  <div>
                    <h3 className="heading-card mb-2">Expert Review</h3>
                    <p className="text-gray-300">
          ...
          <div className="mb-20">
            <h2 className="heading-section">Advanced Technologies</h2>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-gray-900 rounded-xl p-6 border border-gray-800">
                ...
                <h3 className="heading-card mb-4">Deep Neural Networks</h3>
                <p className="text-gray-300">
              ...
              <div className="bg-gray-900 rounded-xl p-6 border border-gray-800">
                ...
                <h3 className="heading-card mb-4">Heat Map Visualization</h3>
                <p className="text-gray-300">
              ...
              <div className="bg-gray-900 rounded-xl p-6 border border-gray-800">
                ...
                <h3 className="heading-card mb-4">Explainable AI</h3>
                <p className="text-gray-300">
          ...
          <div className="mb-20">
            <h2 className="heading-section">See The Difference</h2>
          ...
          <div className="mb-20">
            <h2 className="heading-section mb-6">Understanding AI Heatmaps</h2>
            <p className="text-center text-gray-300 mb-10 max-w-3xl mx-auto">
            ...
            <div className="bg-gray-900 rounded-xl p-8 border border-gray-800">
              <div className="grid md:grid-cols-3 gap-8">
                <div className="text-center">
                  ...
                  <h3 className="heading-card mb-2">Red Regions</h3>
                ...
                <div className="text-center">
                  ...
                  <h3 className="heading-card mb-2">Yellow Regions</h3>
                  <p className="text-gray-300 text-sm">
                ...
                <div className="text-center">
                  ...
                  <h3 className="heading-card mb-2">Blue Regions</h3>
                  <p className="text-gray-300 text-sm">
              ...
              <div className="mt-8 border-t border-gray-700 pt-6">
                <h3 className="heading-subsection mb-4 text-center">Color Intensity Indicates Confidence</h3>
          ...
          <div className="bg-gray-900 rounded-xl p-8 border border-gray-800 mb-20">
            <h2 className="heading-section">Training Process</h2>
            ...
            <div className="grid md:grid-cols-4 gap-6">
              <div className="text-center">
                ...
                <h3 className="heading-card mb-3">Data Collection</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="heading-card mb-3">Expert Annotation</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="heading-card mb-3">Model Training</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="heading-card mb-3">Clinical Validation</h3>
          ...
          <div className="mb-20">
            <h2 className="heading-section">Clinical Performance</h2>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-gradient-to-br from-purple-900/20 to-indigo-900/20 p-8 rounded-xl border border-purple-500/30 text-center">
                <div className="heading-tertiary-gradient mb-2">97%</div>
                <h3 className="heading-card mb-4">Sensitivity for Critical Findings</h3>
                <p className="text-gray-300">
              ...
              <div className="bg-gradient-to-br from-purple-900/20 to-indigo-900/20 p-8 rounded-xl border border-purple-500/30 text-center">
                <div className="heading-tertiary-gradient mb-2">94%</div>
                <h3 className="heading-card mb-4">Overall Accuracy</h3>
                <p className="text-gray-300">
              ...
              <div className="bg-gradient-to-br from-purple-900/20 to-indigo-900/20 p-8 rounded-xl border border-purple-500/30 text-center">
                <div className="heading-tertiary-gradient mb-2">&lt;20s</div>
                <h3 className="heading-card mb-4">Analysis Time</h3>
                <p className="text-gray-300">
          ...
          <div className="bg-gradient-to-r from-purple-900/50 to-indigo-900/50 rounded-2xl p-10 text-center border border-purple-500/30">
            <h2 className="heading-tertiary mb-4">Ready to Experience ZemedicAI?</h2>
