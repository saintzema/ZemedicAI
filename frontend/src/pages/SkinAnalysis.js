...
import { FaInfoCircle, FaCloudUploadAlt, FaHistory, FaAllergies } from 'react-icons/fa';
...
const SkinAnalysis = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Skin Lesion Analysis</h1>
        <div className="flex items-center text-gray-600">
          <FaAllergies className="mr-2 text-[#36b649]" />
          <p>Upload skin lesion images for AI-powered analysis and detection</p>
        </div>
      </div>
          ...
          <div className="bg-white shadow-lg rounded-lg p-6 border border-gray-200">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-xl font-semibold text-gray-800 flex items-center">
                <FaCloudUploadAlt className="mr-2 text-[#36b649]" />
            ...
            <button
              ...
              className={`w-full py-3 px-4 rounded-md font-medium transition-all duration-200 flex items-center justify-center ${
                (!file || loading) 
                  ...
                  : 'bg-[#36b649] text-white hover:bg-green-600'
              }`}
            >
              {loading ? (
                <>
        ...
        <div className="lg:col-span-1">
          <div className="bg-white shadow-lg rounded-lg p-6 border border-gray-200 h-full">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-xl font-semibold text-gray-800 flex items-center">
                <FaHistory className="mr-2 text-[#36b649]" />
                Recent Activity
              </h2>
            </div>
                ...
                {recentUploads.map((upload) => (
                  <div key={upload.id} className="flex items-center p-2 rounded-md hover:bg-gray-50">
                    <div className="h-12 w-12 flex-shrink-0 rounded-md overflow-hidden">
                      <img src={upload.imageUrl} alt="Skin lesion thumbnail" className="h-full w-full object-cover" />
                    </div>
                    <div className="ml-3">
      ...
      {/* Information Panel */}
      <div className="mt-8 bg-gradient-to-r from-[#36b649] to-[#5718e3] text-white rounded-lg p-6 shadow-lg">
        <h3 className="text-xl font-bold mb-4">About Skin Lesion AI Analysis</h3>
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <p className="mb-3">
              Our AI model is trained on over 50,000 dermatological images from the ISIC dataset and 
              validated against dermatologist diagnoses with 91% accuracy.
            </p>
            <p className="text-sm">
              ...
              Always consult with a qualified dermatologist for interpretation of results.
            </p>
          </div>
        </div>
      </div>
